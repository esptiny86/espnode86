            ...
            if (conn.inlet_class !== "DAC")
            {
                if (conn.outlet_alias.toLowerCase() === "out")
                {
                    ...
                    if (conn.outlet_class !== "ModuleConstant")
                    {
                        ...
                        {
                            setup_string = setup_string + conn.inlet_class_alias + "->" + conn.inlet_alias.toLowerCase() + '= &ampparam[' + (parseInt(conn.outlet_alias.toLowerCase().replace(/\D/g,''))-1) +"];\n";
