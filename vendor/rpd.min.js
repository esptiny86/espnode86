...
"rpd-outlets-target")})});return{element:l.node(),size:p.size?{width:p.size.width||70,height:p.size.height||30}:{width:70,height:30}}},createInlet:function(f,p){var l=m.select(document.createElement("tr")).attr("class","rpd-inlet").call(function(e){e.append("td").attr("class","rpd-connector");e.append("td").attr("class","rpd-value-holder").append("span").attr("class","rpd-value");e.append("td").attr("class","rpd-name").text(f.def.label||f.alias);b.showTypes&&e.append("td").attr("class","rpd-type").text(f.type)});
